...
$backdrop_info = "font-size: 18px; color: #516067; word-break: break-all; word-wrap: break-word;";
$backdrop_info_small = "font-size: 14px; font-style:italic; color: #516067; word-break: break-all; word-wrap: break-word;";
                    ...
                    <tr>
                        <td>
                            <table width="300" bgcolor="#F8F8F8" cellpadding="15" cellspacing="0" style="<?php echo $backdrop_container; ?>">
                                <tr>
                                    <td bgcolor="#F8F8F8" align="center" style="border-bottom:1px solid #E4E4E4; <?php echo $backdrop_info; ?>">
                                        <?php echo $_GET['session_name']; ?>
                                    </td>
                                </tr>
                                <?php if($_GET['email_message'] != "") { ?>
                                    <tr>
                                        <td bgcolor="#f2f2f2" align="center" style="border-bottom:1px solid #CCCCCC; <?php echo $backdrop_info_small; ?>">
