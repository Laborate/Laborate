...
exports.locals = function(req, res, next) {
    ...
    res.locals.site_title = (req.session.organization) ? req.session.organization.logo : config.general.company;
    ...
    res.locals.logo = (req.session.organization) ? req.session.organization.logo : config.general.logo;
    res.locals.backdrop = "";
