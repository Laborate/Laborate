...
module.exports = function(app) {
    ...
    /* Account */
    app.get("/account", authUtil.restrictAccess, core.realtime, account.index);
    app.get("/account/:panel", authUtil.restrictAccess, core.realtime, account.index);
    ...
    app.get('/editor/:document', authUtil.restrictAccess, core.realtime, editor.access_token, editor.index);
