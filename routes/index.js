...
module.exports = function(app) {
    /* Root */
    app.get('/', authUtil.removeRedirect, authUtil.loginGenerate, landing.index);
    ...
    app.get('/welcome/gravatar',authUtil.restrictAccess, welcome.gravatar);
    ...
    app.post('/documents/file/:document/private', authUtil.restrictAccess, authUtil.xhr, documents.stats, documents.file_private);
