CodeMirror.defineMode("python", function(conf, parserConf) {
    ...
    var commonBuiltins = ['abs', 'all', 'any', 'bin', 'bool', 'bytearray', 'callable', 'chr',
                          ...
                          'type', 'vars', 'zip', '__import__', 'NotImplemented', 'Exception',
                          "BaseException", "args", "Exception", "StandardError", "ArithmeticError",
                          ...
                          "encoding", "reason", "object", "start", "end", "UnicodeEncodeError", "UnicodeDecodeError",
