module.exports = function() {
    ...
    /* Print Mode */
    clientCSS.addFile("print", css_path + 'editor/print.less');

    clientJS.addUrl("print", '/socket.io/socket.io.js');
    clientJS.addFile("print", js_path + 'editor/print.js');
    ...
    clientJS.addFile("editor", js_path + 'backdrop/backdropEditor.js');
    ...
    clientJS.addFile("editor", codemirror_path + 'lib/codemirror.js');
    ...
    clientJS.addFile("editor", codemirror_path + 'addon/display/placeholder.js');
