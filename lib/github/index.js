...
exports.commit = function(token, repo, branch, path, content, message, callback) {
    var client = github.client(token);
    async.waterfall([
        function(next) {
            client.get('repos/' + repo + '/branches', function (error, status, body) {
                next(error, body[0]['commit']['sha']);
            });
        },
        function(sha, next) {
