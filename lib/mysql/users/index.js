...
exports.user_insert = function(info, callback) {
    ...
    var sql = "INSERT INTO users \
               (user_name, user_screen_name, user_email, user_password, user_verified) \
...
/* Update User Info */
exports.user_verification = function(id, code, callback) {
    var connection = mysql.create_connection(connection);

    var sql = "UPDATE users SET \
               user_verified=" + connection.escape(code) + " \
