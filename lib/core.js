exports.dependencies = function(req, res, next){
    ...
    /* Accounts */
    css_client.addFile("documents", css_path + 'account/account.less');
    js_client.addFile("documents", js_path + 'account/account.js');
    js_client.addFile("documents", js_path + 'account/accountInit.js');
    js_client.addFile("documents", js_path + 'account/accountUtil.js');
