    ...
    var users = db.define("users", {
        ...
        hooks: {
            ...
            afterAutoFetch: function() {
                ...
                if(_this.organizations && !_this.organizations.empty && _this.organizations[0].gravatar) {
        ...
        methods: {
            ...
            set_verify: function() {
                this.save({ verify: rand.generateKey(30).toLowerCase() });
            },
            set_reset: function() {
