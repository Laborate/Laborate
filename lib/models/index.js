...
function configure(db, models, init, callback) {
    ...
    models.users.groups.hasMany("users", models.users, {}, {reverse: 'groups', autoFetch: true});
    ...
    models.posts.hasOne("group", models.users.groups, {reverse: 'posts', autoFetch: true});
