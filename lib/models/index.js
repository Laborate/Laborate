...
function configure(db, models) {
    ...
    models.organizations.roles.hasOne("organization", models.documents, {reverse: 'roles', required: true});
    models.organizations.roles.hasOne("user", models.users, {required: true});
    models.organizations.roles.hasOne("permission", models.documents.permissions, {required: true});
