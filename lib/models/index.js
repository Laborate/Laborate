...
function configure(db, models, init, callback) {
    ...
    /* Page Settings */
    models.users.settings.set("pagination.perpage", 11);

    models.organizations.settings.set("pagination.perpage", 11);
    models.organizations.roles.settings.set("pagination.perpage", 11);

    models.documents.settings.set("pagination.perpage", 11);
    models.documents.roles.settings.set("pagination.perpage", 11);

    models.posts.settings.set("pagination.perpage", 11);
    models.posts.tags.settings.set("pagination.perpage", 11);
    ...
    models.posts.hasMany("tags", models.posts.tags, {}, {reverse: 'posts', autoFetch: true});
    ...
    if(init) {
        async.series([
            ...
            function(next) {
                if(config.orm.reset || config.orm.reload) {
